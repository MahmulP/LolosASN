...
import com.lolos.asn.ui.activity.ResultDiscussionActivity

class DiscussionNumberAdapter(
    private val parentActivity: ResultDiscussionActivity,
    private val viewModel: ExaminationViewModel
) : ListAdapter<TryoutContentItem, DiscussionNumberAdapter.MyViewHolder>(DIFF_CALLBACK) {
