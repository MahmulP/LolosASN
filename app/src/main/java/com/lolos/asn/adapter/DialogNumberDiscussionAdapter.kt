...
class DialogNumberDiscussionAdapter(
    private val viewModel: ExaminationViewModel,
    private val dialogFragment: NumberDiscussionDialogFragment
) : ListAdapter<TryoutContentItem, DialogNumberDiscussionAdapter.MyViewHolder>(DIFF_CALLBACK) {
